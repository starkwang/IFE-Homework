	...
	var Category = React.createClass({displayName: "Category",
		render : function(){
			var catagoryNodes = this.props.data.map(function(category){
				...
				return (
					React.createElement("div", {className: "categoryItem", id: _category.id, onClick: GotoTask, onTouchMove: PreventClick, onTouchEnd: GotoTask}, 
						category.title
					)
				);
			});
	...
	var Task = React.createClass({displayName: "Task",
		render : function(){
			var taskNodes = this.props.model.map(function(task){
				...
				return(
					React.createElement("div", {className: "taskItem", id: _task.id, onClick: GotoContent, onTouchMove: PreventClick, onTouchEnd: GotoContent}, 
						task.title
					)
				);
			})
